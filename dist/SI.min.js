...
function(a){c(!0,b,a)}).fail(function(){d()})}function e(a,b,c,d){var e=new Image;e.addEventListener("load",function(a){c(!0,b,e)},!1);e.addEventListener("error",function(a){d()},!1);q||(a+="?time="+$.now());e.src=a}function f(a,b,d,e,l){if(d!=c.AUDIO_EXTENSION_TO_USE)e(!1,b,null);else{var f=new Audio;f.addEventListener("loadeddata",function(a){e(!0,b,f)},!1);f.addEventListener("error",function(a){l()},!1);q||(a+="?time="+$.now());f.src=a;f.load()}}var c=this;c.RESOURCE_LIST_URL="res/resourceList.php";
